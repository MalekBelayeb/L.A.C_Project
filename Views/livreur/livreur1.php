...
<div id="primary" class="container">
	...
	<div class="entry-content">
			...
			<div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-offset-1 vc_col-lg-10"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="woocommerce">	<p class="return-to-shop">
		
<br>
<br><br>
            <a class="button wc-backward" href="../livreur/afficherLivraison_livreur.php">
            les reçus des livraisons       </a>

            <a class="button wc-backward" href="../livreur/etatLivraison_livreur.php">
            etat livraison      </a>

           <a class="button wc-backward" href="liv2.php">
            calendrier      </a>
...
<form action="livreur1.php" method="POST" >

<button name="modifier" class="button wc-backward" onclick="getLocation()">localisation</button>
