...
<div class="wrap-boxed"><div id="page" class="hfeed site">
    ...
    <div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="woocommerce">
                        <div class="container" style="background: white; border: red">
                        <form id="payment-form" name="checkout" method="post" class="col-md-4 col-md-offset-4" action="../../Core/Order.php?id=stripe" enctype="multipart/form-data" style="text-align: center">
                        <br><br>
                            <div class="woocommerce-order">
                            <div  id="payment_method_stripe_text">
                            ...
                            <input type="submit" class="btn btn-primary" name="woocommerce_checkout_place_order" id="place_order" value="Pay Now" data-value="Pay Now" />
                        </form>
                            <br>
                        </div>
                    </div></div></div></div></div>
