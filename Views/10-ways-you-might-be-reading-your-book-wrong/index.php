...
<!-- Mirrored from demo.cmssuperheroes.com/themeforest/bookjunky/10-ways-you-might-be-reading-your-book-wrong/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Feb 2018 22:33:16 GMT -->
...
<title>10 Ways You Might Be Reading Your Book Wrong &#8211; Book Junky</title>
...
<link rel="alternate" type="application/rss+xml" title="Book Junky &raquo; 10 Ways You Might Be Reading Your Book Wrong Comments Feed" href="feed/index.html" />
...
<link rel='prev' title='The World of Abstract Art Explained' href='../the-world-of-abstract-art-explained/index.html' />
<meta name="generator" content="WordPress 4.9.2" />
<meta name="generator" content="WooCommerce 3.2.6" />
<link rel="canonical" href="index.html" />
<link rel='shortlink' href='../index0721.html?p=60' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed27ec.json?url=http%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fbookjunky%2F10-ways-you-might-be-reading-your-book-wrong%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed0094?url=http%3A%2F%2Fdemo.cmssuperheroes.com%2Fthemeforest%2Fbookjunky%2F10-ways-you-might-be-reading-your-book-wrong%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-60 single-format-standard body-boxed wpb-js-composer js-comp-ver-5.2.1 vc_responsive">
...
<li id="menu-item-250" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children no_group menu-item-250" data-depth="0"><a href="../news/evenements.php" class=""><span class="menu-title">Evenement</span></a>
...
$req = $ev_classe->afficherdapresid($_GET['id_ev']);
$donnes = $req->fetch();
...
?>
                    ...
                    <h1><?php   echo $donnes['nom_ev'];  ?></h1>




                            <p>  <table class="countdownContainer">
                        <tr class="info">
                            <td id="days<?php  echo $donnes['id_ev']; ?>"><td>Days   </td></td>
                            <td id="hours<?php  echo $donnes['id_ev']; ?>"><td>Hours  </td></td>
                            <td id="minutes<?php  echo $donnes['id_ev']; ?>"><td>Minutes  </td></td>
                            <td id="secondes<?php  echo $donnes['id_ev']; ?>"><td>Secondes  </td></td>
...
<article id="post-60" class="post-60 post type-post status-publish format-standard has-post-thumbnail hentry category-action category-comedy category-drama tag-best-sellers tag-comics tag-fiction tag-litterature tag-lorem-ipsum">

	<div class="wrap-thumbnail">

		<img width="400" height="270" src="../wp-content/uploads/<?php   echo $donnes['image_ev'];  ?>" class="attachment-large size-large wp-post-image" alt="" />    </div>


	<header class="entry-header">


		<h3 class="entry-title"><?php   echo $donnes['nom_ev'];  ?></h3>
		...
		<div class="entry-meta">
            ...
            <li class="detail-date"><i class="zmdi zmdi-calendar"></i> <?php   echo $donnes['date_ev'];  ?></li>
...
/*
                            ...
                            {
                                setInterval("rafraichissement()",100);
                            }                            
...
if($interval1->invert==0)
{
   $core = new evenementcore();
    $core-> delete_evenement($donnes['id_ev']);
...
<!--
		...
		<h3 id="reply-title" class="comment-reply-title">Leave Comment <small><a rel="nofollow" id="cancel-comment-reply-link" href="index.html#respond" style="display:none;">Cancel Comment</a></small></h3>			<form action="http://demo.cmssuperheroes.com/themeforest/bookjunky/wp-comments-post.php" method="post" id="commentform" class="comment-form">
				<div class="row"><div class="comment-form-author col-md-6 col-sm-12 col-xs-12"><input id="author" name="author" type="text" value="" size="30" placeholder="Your Name"/></div>
...
<div class="comment-form-comment"><textarea id="comment" name="comment" cols="45" rows="8" placeholder="Comment" aria-required="true"></textarea></div><p class="form-submit"><input name="submit" type="submit" id="submit" class="submit" value="Send Comment" /> <input type='hidden' name='comment_post_ID' value='60' id='comment_post_ID' />
<input type='hidden' name='comment_parent' id='comment_parent' value='0' />
	...
	<!--
		<ol class="comment-list">
					<li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1 parent" id="comment-8">
				<div id="div-comment-8" class="comment-body">
				<div class="comment-author vcard">
			<img alt='' src='http://0.gravatar.com/avatar/98fe66df1c624a3290ec03e14878e096?s=85&amp;d=mm&amp;r=g' srcset='http://0.gravatar.com/avatar/98fe66df1c624a3290ec03e14878e096?s=170&#038;d=mm&#038;r=g 2x' class='avatar avatar-85 photo' height='85' width='85' />			<cite class="fn">admin</cite> <span class="says">says:</span>		</div>
		
		<div class="comment-meta commentmetadata"><a href="index.html#comment-8">
			September 4, 2017 at 1:53 am</a>		</div>

		<p>i don&#8217;t care</p>

		<div class="reply"><a rel='nofollow' class='comment-reply-link' href='index94a5.html?replytocom=8#respond' onclick='return addComment.moveForm( "div-comment-8", "8", "respond", "60" )' aria-label='Reply to admin'>Reply</a></div>
				</div>
		<ol class="children">
		...
		<div class="comment-meta commentmetadata"><a href="index.html#comment-9">
			September 4, 2017 at 2:04 am</a>		</div>

		<p>thanks !</p>

		<div class="reply"><a rel='nofollow' class='comment-reply-link' href='indexfc06.html?replytocom=9#respond' onclick='return addComment.moveForm( "div-comment-9", "9", "respond", "60" )' aria-label='Reply to admin'>Reply</a></div>
				</div>
		</li><!-- #comment-## -->
</ol><!-- .children -->
</li><!-- #comment-## -->
...
<aside id="cms_recent_posts-2" class="widget cms-recent-posts"><h3 class="wg-title">RECENT POSTS</h3>                                 
...
<script type='text/javascript'>
/* <![CDATA[ */
var nectarLove = {"ajaxurl":"http:\/\/demo.cmssuperheroes.com\/themeforest\/bookjunky\/wp-admin\/admin-ajax.php","postID":"60","rooturl":"http:\/\/demo.cmssuperheroes.com\/themeforest\/bookjunky"};
/* ]]> */
</script>
...
<!-- Mirrored from demo.cmssuperheroes.com/themeforest/bookjunky/10-ways-you-might-be-reading-your-book-wrong/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Feb 2018 22:33:18 GMT -->
</html>
...
<!-- Cached page generated by WP-Super-Cache on 2018-02-03 22:29:19 -->
