...
<!-- Mirrored from demo.cmssuperheroes.com/themeforest/bookjunky/news/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Feb 2018 22:29:14 GMT -->
...
<body class="page-template page-template-page-templates page-template-blog-classic page-template-page-templatesblog-classic-php page page-id-105 body-boxed wpb-js-composer js-comp-ver-5.2.1 vc_responsive">
...
include_once "C:/wamp/www/bookjunky/backoffice/core/usercore.php";
$user = New Usercore();
$usr = $user->Afficher_user();
    ...
    {$connecter = true;
            ...
            $product = $usr->fetch(PDO::FETCH_ASSOC);

    echo 'Votre login est <b>'.$_SESSION['login_user'].'</b> <br>et votre mot de passe est <b>'.$_SESSION['pw_user'].
    '</b><br>Votre role est : '.$product['ROLE'].' <br> l id est:'. $_SESSION['id_user'].'<br/> Identifiant de la session est :'.session_id().'</br>'; 
    echo '<a href="C:\wampwww/bookjunky/logout.php">Cliquer pour se déconnecter</a>';
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            ...
	            <div class="col-xs-12 col-md-4 col-lg-3">
	                ...
	                <div class="main-logo-3"><a href="../bo.php"><img alt="Book Junky" src="../wp-content/themes/book-junky/assets/images/logo-2.png"></a></div>
...
<li id="menu-item-250" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children no_group menu-item-250" data-depth="0"><a href="evenements.php" class=""><span class="menu-title">Evenement</span></a>
...
include_once "C:/wamp/www/bookjunky/backoffice/core/evenementcore.php";
