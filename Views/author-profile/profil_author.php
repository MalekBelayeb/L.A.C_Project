...
$donnees = $auteur->Afficher_auteur_id($_GET['id_author']);
...
$bks = $book->Get_Livre_idAuteur($_GET['id_author']);
 ...
 ?>
        ...
        <div class="wrap-content">
            <div class="cms-grid-media"
                ...
                <img width="330" height="500" src="../wp-content/uploads/<?php echo $product['IMAGE']; ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />            </div>
            <div class="info-product">
                <a class="product-title"
                   href="../shop/shattered/profil.php?id_book=<?php echo $product['ID'] ?>"><?php  echo $product['NOM'];    ?></a>
                <p class="product-author">by: <?php   echo $product['AUTHOR'];  ?>              </p>
