...
<!-- #masthead -->
        <div id="page-title-1" class="page-title text-center">
            <h1>MODIFIER Laivraison a domicile</h1>
        </div>
        </div>
...
<form  id="register-form"  action="modifierLaivraison.php"   method="POST">
<table>
<caption>Modifier livraison</caption>
<tr>
<td>code_Livraison</td>
<td><input type="text" name="code_Livraison" disabled="disabled" value="<?PHP echo $code_Livraison ?>" ></td>
<td><input type="hidden" name="code_Livraison"  value="<?PHP echo $code_Livraison ?>" ></td>
...
<td><input type="text" name="adresse_ligne_1" value="<?PHP echo $adresse_ligne_1 ?>"></td>
</tr>
<tr>

    <tr>
<td>adresse_ligne_2</td>
<td><input type="text" name="adresse_ligne_2" value="<?PHP echo $adresse_ligne_2 ?>"></td>
</tr>
<tr>
...
<td><input type="text" name="date_laivraison" disabled="disabled" value="<?PHP echo $date_laivraison ?> "></td>
<td><input type="hidden" name="date_laivraison"  value="<?PHP echo $date_laivraison ?> "></td>
</tr>
<tr>

     <tr>
<td>livreur</td>
<td><input type="text" name="livreur"  disabled="disabled" value="<?PHP echo $livreur ?> "></td>
<td><input type="hidden" name="livreur"  value="<?PHP echo $livreur ?> "></td>
</tr>
<tr>
...
?>
 ...
 <div class="woocommerce">   <p class="return-to-shop">
            ...
            <a href="afficherLaivraison.php">returne</a>
