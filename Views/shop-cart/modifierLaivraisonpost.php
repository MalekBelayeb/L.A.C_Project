...
if (isset($_GET['cin'])){
    ...
    foreach($result as $row){
        $code_Livraison_p=$row['code_Livraison_p'];
        $nom=$row['nom'];
        $prenom=$row['prenom'];
        ...
        $date_laivraison_p=$row['date_laivraison_p'];
        $prix=$row['prix'];
...
<form  id="register-form"  action="modifierLaivraisonpost.php"   method="POST">
<table>
<caption>Modifier Employe</caption>
<tr>
<td>code_Livraison_p</td>
<td><input type="text" name="code_Livraison_p" disabled="disabled" value="<?PHP echo $code_Livraison_p ?>"></td>
<td><input type="hidden" name="code_Livraison_p" value="<?PHP echo $code_Livraison_p ?>"></td>
</tr>
...
<td><input type="text" name="code_postale" value="<?PHP echo $code_postale ?>"></td>
</tr>
<tr>
    ...
    <td>ville</td>
                      <td> <select name="ville" class="select1">
                        ...
                        <option value="kef"> kef </option>
                         ...
                         <option value="gafssa"> gafssa  </option></select></td>
...
<td><input type="text" name="date_laivraison_p"  disabled="disabled" value="<?PHP echo $date_laivraison_p ?> "></td>
<td><input type="hidden" name="date_laivraison_p" value="<?PHP echo $date_laivraison_p ?> "></td>
</tr>
<tr>
      <tr>
<td>prix</td>
<td><input type="text" name="prix" disabled="disabled" value="<?PHP echo $prix ?> "></td>
<td><input type="hidden" name="prix" value="<?PHP echo $prix ?> "></td>
</tr>
<tr>
...
if (isset($_POST['modifier'])){
    $employe=new laivraisonposte($_POST['nom'],$_POST['prenom'],$_POST['code_postale'],$_POST['ville'],$_POST['mail'],$_POST['num_tel'],$_POST['code_livre'],$_POST['date_laivraison_p'],$_SESSION['livraisonPrix']);

    $employe->setcode_Livraison_p($_POST['code_Livraison_p']);
...
?>
 ...
 <div class="woocommerce">   <p class="return-to-shop">
            ...
            <a href="afficherLaivraisonpost.php">returne</a>
