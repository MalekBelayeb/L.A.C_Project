...
<!-- #masthead -->
        <div id="page-title-1" class="page-title text-center">
            <h1>Livraison post</h1>
                     ...
                     <form  id="register-form" action="ajouterLaivraison_post.php" method="POST">


                        
                        <label class="raed">nom       </label>
                        <input type="text" class="livraison2"  name="nom" id="fff" value="<?PHP echo $_SESSION['NOM'] ?>" placeholder="nom..."  onblur="check_all();"><br>
                        ...
                        <label class="raed">code_postale:</label>
                        <input type="text" class="livraison3" name="code_postale" value="" placeholder="code_postale..."><br>
