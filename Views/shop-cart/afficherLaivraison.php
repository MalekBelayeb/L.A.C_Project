...
include "../../Core/laivraisonC.php";
                             ...
                             //echo   $datee;
                             $listeEmployes=$employe1C->afficherLaivraisonforone($_SESSION['NOM'],  $datee);
                             $listeEmployestous=$employe1C->afficherLaivraisonforonetous($_SESSION['NOM']);
...
foreach($listeEmployes as $row){
    ...
    <input type="hidden" value="<?PHP echo $row['code_Livraison']; ?>" name="cin">
    </form>
    </td>
    <td>
        ...
        <a href="modifierLaivraison.php?cin=<?PHP echo $row['code_Livraison']; ?>">
      <?php
    $today = date("Y-m-d");
