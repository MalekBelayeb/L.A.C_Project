            ...
            <h1>LISTE DES Laivraison post</h1>
                        ...
                        <br>
                            ...
                            include "../../Core/laivraison_postC.php";
                             ...
                             $listeEmployes=$employe1C->afficherLaivraisonforone_p($_SESSION['NOM'],  $datee);
                             $listeEmployestous=$employe1C->afficherLaivraisonforonetous_p($_SESSION['NOM']);
...
foreach($listeEmployes as $row){
    ...
    <input type="hidden" value="<?PHP echo $row['code_Livraison_p']; ?>" name="cin">
    </form>
    </td>
    <td><a href="modifierLaivraisonpost.php?cin=<?PHP echo $row['code_Livraison_p']; ?>">
    Modifier</a></td>
...
<?PHP
foreach($listeEmployestous as $row){
    ?>
    <tr>
