 ...
 <li class="nav-item" data-toggle="tooltip" data-placement="right" title="livraison">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <a class="btn btn-primary" href="afficherLivraisonPost_admin1.php" id="toggleNavColor">afficher laivraison pose </a>

      <a class="btn btn-primary" href="tables.php" id="toggleNavColor">afficher table </a>
