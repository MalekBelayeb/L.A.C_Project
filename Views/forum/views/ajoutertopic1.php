            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-6 top-left-3">
                                            ...
                                            <a class="go_to_login_link" href="" >Logout</a>
            <a href="file:///C:/Users/Lyes/Desktop/WEB/template/bookjunky/homepage-4/forum.php">forum</a><a href="#">Contact Us</a>                    </div>
       ...
       <div class="container">
           ...
           <div class="row">
               ...
               <div class="col-xs-12 col-md-4 col-lg-3">
                   ...
                   <div class="main-logo-3"><a href="../homepage-1/index.html"><img alt="Book Junky" src="../wp-content/themes/book-junky/assets/images/logo-2.png"></a></div>
...
<form method="POST" action="ajoutertopic.php">
	<fieldset>
		<legend style="color: blue">Ajouter Une Categorie</legend>
		...
		<td><input class="controle" type="text" name="nom"   required pattern="[A-z-\.]{3,12}" placeholder=" / 3-12 caract">
...
<form method="POST" action="ajoutertopic.php">
	<fieldset>
		<legend style="color: blue">Ajouter Uno Topic</legend>
		<input type="hidden" name="idd"  disabled>
		<table>
		<tr>
		<td>Titre du forum :</td><td> <select name="forum" size="1">
		<?php while ($c = $categories->fetch())  { ?>
		<option  value="<?PHP echo $c['nom'] ?>" ><?= $c['nom'] ?></option>
		<?php } ?>
		
	</select></td></tr>
		
		<tr><td>Titre Du Topic: </td><td><input class="controle" type="text" name="nomm"  required pattern="[A-Z-\.]{3,12}" placeholder="ALL Maj /3-12 caract">
    <span class="resultat"></span></td></td></tr>
		<tr>
			<td></td><td><input type="submit" name="ajouterr" value="-Ajouter-"></td>
		</tr>
		</table>
