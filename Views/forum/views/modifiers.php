...
if (isset($_GET['id'])){
    ...
    $result=$stopicT->recuperersTopics($_GET['id']);
...
<tr>
<td></td>
<td><input type="submit" name="modifierr" value="modifier"></td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifierr'])){
	$stopic=new stopic($_POST['id'],$_POST['nom'],$_POST['id_categorie'],$_POST['Date']);
	$stopicT->modifiersTopic($stopic,$_POST['id_ini']);
	//echo $_POST['id_ini'];
