...
if (isset($_GET['id'])){
	$topicT=new Topiccore();
    $result=$topicT->recupererTopic($_GET['id']);
...
<table>
<caption>Modifier nom de forum</caption>
...
if (isset($_POST['modifier'])){
	$topic=new topic($_POST['id'],$_POST['nom'],$_POST['Date']);
	$topicT->modifierTopic($topic,$_POST['id_ini']);
	//echo $_POST['id_ini'];
	//header('Location:modifiernomforum.php');
