...
$core= new  Contenircore();
$liste=$core->afficher1();
?>
...
<br/><br/><br/>
<center>
<h4 style="color: white ; font-style: italic;">Reclamer</h4>
</center>
</div>
<form method="POST" action="ajoutercontenir.php" ><fieldset>
		<legend style="color: blue">Ajouter Un  Content</legend>
		<input type="hidden" name="id"  disabled>
		<table>
		<tr>
		<td>Titre du Topic :</td><td> <select name="foruma" size="1">
		<?php foreach ($liste as $row )  { ?>
		<option  value="<?PHP echo $row['nom'] ?>" ><?= $row['nom'] ?></option>
		<?php } ?>
		
	</select></td></tr>
		
		<tr><td>Content: </td><td><textarea type="text" name="nom"></textarea></td></tr>
		<tr>
