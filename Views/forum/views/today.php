...
<tr>
<td style="font-style: italic;color: blue">Categorie du jour </td>
<td style="font-style: italic;color: blue"> Topic du jour </td>
<td style="font-style: italic;color: blue"> les content du jour </td>
...
<?php
    	...
    	echo $row['nom']; ?>  [Categorie : <?php
    	$listeb=$core->recherche2($row['id_categorie']);
...
?>
 [Topic :  <?php 
$listed=$core->recherche1($row['id_souscategorie']);

    	foreach($listed as $ro)
    	{
...
/Catgorie : <?php
$listee=$core->recherche2($ro['id_categorie']);

    	foreach($listee as $rr)
    	{
