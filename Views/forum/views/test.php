...
if (isset($_GET['id'])){
  $stopicT=new Topiccore();
    $result=$stopicT->recuperer($_GET['id']);
...
<tr> 
<td>
  <a href="conteniraffiche.php?id=<?PHP echo $row['id']; ?>"><?php echo $nom ?></a>
</td>

<td>

        <a href="modifiers.php?id=<?PHP echo $row['id']; ?>">Modifier</a></td>

        <td></td>
        <td><?PHP  
   echo $row['Date']; ?></td>
      <?php // echo $sc['nom']  ?><!--</a></td></tr>-->
<?php } }//}?>
</tr>
</table>
